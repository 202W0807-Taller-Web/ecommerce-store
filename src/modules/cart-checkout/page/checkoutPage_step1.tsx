...
export default function Checkout_Step1() {
  ...
  const subtotal = passedCart.reduce(
  ...
  const shipping = selected
    ? shippingOptions.find((o) => o.id === selected)?.price || 0
    : 0;
              ...
              return (
                ...
                >
                  <div className="flex justify-between items-center mb-2">
                    <h2
                      className={`text-xl font-semibold ${isSelected ? "text-[#EBC431]" : "text-[#F5F5F5]"}`}
                    >
                      {option.name}
                    </h2>
                    {isSelected && (
                  ...
                  <p
                    className={`mt-2 font-semibold ${isSelected ? "text-[#EBC431]" : "text-[#C0A648]"}`}
                  >
                    {option.price === 0
                      ? "GRATIS"
